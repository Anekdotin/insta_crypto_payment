...
def rpc_call_for_incomming_deposits():
    ...
    for i in (response_json['result']):
        ...
        add_transaction = Transactions(
            ...
            amount_btc=0,
            amount_xmr=0,
            amount_bch=amount_decimal_form
        )
